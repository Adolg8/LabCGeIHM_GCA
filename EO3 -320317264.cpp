...
//model = glm::translate(model, glm::vec3(0.0f, 0.0f, -3.0f));
glUniform3fv(uniformColor, 1, glm::value_ptr(color));
model = glm::translate(model, glm::vec3(-0.2f, -0.4f, -3.5f));
...
//model = glm::translate(model, glm::vec3(0.0f, 0.0f, -3.0f));
glUniform3fv(uniformColor, 1, glm::value_ptr(color));
model = glm::translate(model, glm::vec3(0.0f, -0.94f, -3.5f));
model = glm::scale(model, glm::vec3(0.3f, 0.3f, 0.0f));
glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));//FALSE ES PARA QUE NO SEA TRANSPUESTA
meshList[0]->RenderMeshGeometry();
...
//model = glm::translate(model, glm::vec3(0.0f, 0.0f, -3.0f));
glUniform3fv(uniformColor, 1, glm::value_ptr(color));
model = glm::translate(model, glm::vec3(-1.3f, -0.95f, -3.0f));
...
//model = glm::translate(model, glm::vec3(0.0f, 0.0f, -3.0f));
glUniform3fv(uniformColor, 1, glm::value_ptr(color));
model = glm::translate(model, glm::vec3(-1.3f, -0.6f, -3.0f));
...
//model = glm::translate(model, glm::vec3(0.0f, 0.0f, -3.0f));
glUniform3fv(uniformColor, 1, glm::value_ptr(color));
model = glm::translate(model, glm::vec3(-0.51f, -0.4f, -2.8f));
model = glm::scale(model, glm::vec3(0.0f, 0.3f, 0.3f));
glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));//FALSE ES PARA QUE NO SEA TRANSPUESTA
meshList[0]->RenderMeshGeometry();
...
//model = glm::translate(model, glm::vec3(0.0f, 0.0f, -3.0f));
glUniform3fv(uniformColor, 1, glm::value_ptr(color));
model = glm::translate(model, glm::vec3(-0.51f, -0.4f, -3.2f));
model = glm::scale(model, glm::vec3(0.0f, 0.3f, 0.3f));
glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));//FALSE ES PARA QUE NO SEA TRANSPUESTA
meshList[0]->RenderMeshGeometry();
...
//model = glm::translate(model, glm::vec3(0.0f, 0.0f, -3.0f));
glUniform3fv(uniformColor, 1, glm::value_ptr(color));
model = glm::translate(model, glm::vec3(-0.0f, -0.5f, -2.49f));
