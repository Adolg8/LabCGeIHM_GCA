...
{
	// Elimina la traslación de la cámara (mantiene solo rotación)
	viewMatrix = glm::mat4(glm::mat3(viewMatrix));

	// 🔽 Desplaza visualmente el skybox hacia abajo
	viewMatrix = glm::translate(viewMatrix, glm::vec3(0.0f, 0.8f, 0.0f));
	// puedes probar con -0.5f, -1.0f, -3.0f, según lo que quieras ver más de "piso"
